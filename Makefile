...
compose:
	docker-compose -f getting-started/src/main/docker/load-balancer.yml up -d --force --build; \
	docker-compose -f getting-started/src/main/docker/monitoring.yml up -d --force
